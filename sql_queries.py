...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, start_time varchar,\
                            user_id varchar , level varchar, song_id varchar , artist_id varchar, session_id varchar, location varchar, \
                            user_agent varchar)""")
...
artist_table_create = ("""CREATE TABLE IF NOT EXISTS artists (artist_id varchar, artist_name varchar, artist_location varchar, \
                        artist_latitude real, artist_longitude real)""")

time_table_create = ("""CREATE TABLE IF NOT EXISTS time (start_time varchar, hour varchar, day varchar, week varchar, month varchar,\
...
song_select = ("""SELECT songs.song_id, artists.artist_id FROM songs INNER JOIN artists ON \
                songs.artist_id = artists.artist_id WHERE title = %s AND \
